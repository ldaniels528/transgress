package com.github.ldaniels528.bourne.watcher

import com.github.ldaniels528.bourne.LoggerFactory
import com.github.ldaniels528.bourne.watcher.models.Trigger
...
/**
  ...
  */
@js.native
trait WatcherConfig extends js.Object {
...
object WatcherConfig {
  ...
  /**
    ...
    * @param config the given [[WatcherConfig watcher configuration]]
    */
  final implicit class WatcherConfigMethods(val config: WatcherConfig) extends AnyVal {
