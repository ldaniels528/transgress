package com.github.ldaniels528.broadway.rest

import io.scalajs.nodejs.Process

/**
  * Broadway Process Helper
...
object ProcessHelper {
  ...
  implicit class ProcessConfigExtensions(val process: Process) extends AnyVal {
    ...
    /**
      ...
      */
    @inline
    def dbConnect: Option[String] = process.env.find(_._1.equalsIgnoreCase("broadway_db")).map(_._2)
