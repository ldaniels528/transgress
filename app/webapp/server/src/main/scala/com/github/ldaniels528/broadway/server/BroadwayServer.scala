package com.github.ldaniels528.broadway.server
...
import com.github.ldaniels528.broadway.server.routes.{DashboardRoutes, _}
...
/**
  ...
  */
object BroadwayServer extends js.JSApp {
  private val logger = LoggerFactory.getLogger(getClass)

  @JSExport
  override def main(): Unit = {
    logger.info("Starting the Broadway Server...")
